...
const std::map<int, const char*> _negotiation_status_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _knegotiation_statusValues, _knegotiation_statusNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void negotiation_message::__set_status(const negotiation_status::type val) {
  this->status = val;
}

void negotiation_message::__set_msg(const std::string& val) {
  this->msg = val;
}
